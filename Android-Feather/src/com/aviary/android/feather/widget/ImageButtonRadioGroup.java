...
public class ImageButtonRadioGroup extends LinearLayout {
	...
	public ImageButtonRadioGroup( Context context, AttributeSet attrs ) {
		...
		TypedArray attributes = context.obtainStyledAttributes( attrs, R.styleable.ImageButtonRadioGroup, /*R.attr.imageButtonRadioButtonStyle*/ 0, 0 );
	...
	public static class LayoutParams extends LinearLayout.LayoutParams {
		 ...
		 * @param w the w
		 * @param h the h
		 * @param initWeight the init weight
		 */
	...
	/**
	 * The listener interface for receiving onCheckedChange events.
	 * The class that is interested in processing a onCheckedChange
	 * event implements this interface, and the object created
	 * with that class is registered with a component using the
	 * component's <code>addOnCheckedChangeListener<code> method. When
	...
	private class CheckedStateTracker implements com.aviary.android.feather.widget.ImageButtonRadioButton.OnCheckedChangeListener {
		...
		/* (non-Javadoc)
		 * @see com.aviary.android.feather.widget.ImageButtonRadioButton.OnCheckedChangeListener#onCheckedChanged(com.aviary.android.feather.widget.ImageButtonRadioButton, boolean)
		 */
		@Override
