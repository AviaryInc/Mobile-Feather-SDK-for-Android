...
public class OverlayGalleryCheckboxDrawable extends DefaultGalleryCheckboxDrawable implements Callback {
	 ...
	 *
	 * @param res {@link Context} resource manager
	 * @param pressed pressed state
	 * @param drawable drawable used as overlay
	 * @param bottomOffset value from 0.0 to 1.0. It's the maximum height of the overlay. According to this value the size and the center of the overlay drawable will change.
	 * @param padding padding of the overlay drawable
	 */
	...
	public OverlayGalleryCheckboxDrawable( Resources res, boolean pressed, Drawable drawable, float bottomOffset, float paddingW, float paddingH ) {
		super( res, pressed );
