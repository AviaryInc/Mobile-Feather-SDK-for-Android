 ...
 * The Class MemePanel.
 */
public class MemePanel extends AbstractContentPanel implements OnEditorActionListener, OnClickListener, OnDrawableEventListener, OnLayoutListener {
	...
	protected void onGenerateResult() {
		...
		MoaActionList actionList = MoaActionFactory.actionList( "memegen" );
		MoaAction action = actionList.get( 0 );
		
		flattenText( topHv, action );
		flattenText( bottomHv, action );
		
		View focus = getContext().getBaseActivity().getCurrentFocus();
		mLogger.log( "focus: " + focus );
	 ...
	 * @param hv the hv
	 */
	private void flattenText( final DrawableHighlightView hv, final MoaAction action ) {

		mLogger.info( "flattenText" );
